...
class WorkerInstance extends events_1.EventEmitter {
    ...
    startProcess() {
        ...
        if (!process.env.JEST_WORKER_ID) {
            (_a = transformStream_1.default(childProcess.stdout, cid)) === null || _a === void 0 ? void 0 : _a.pipe(stdOutStream);
            (_b = transformStream_1.default(childProcess.stderr, cid)) === null || _b === void 0 ? void 0 : _b.pipe(stdErrStream);
        }
        return childProcess;
    }
